...
$.extend($.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format("<br>Please enter no more than {0} characters."),
		minlength: $.validator.format("<br>Please enter at least {0} characters."),
		rangelength: $.validator.format("<br>Please enter a value between {0} and {1} characters long."),
		range: $.validator.format("<br>Please enter a value between {0} and {1}."),
		max: $.validator.format("<br>Please enter a value less than or equal to {0}."),
		min: $.validator.format("<br>Please enter a value greater than or equal to {0}.")
	},
